...
const { fetchEndpoints, fetchAllProjects, fetchProjectByID, insertNewProject, editProjectByID } = require('./model');
...
module.exports = { getEndpoints, getAllProjects, getProjectByID, postNewProject, patchProjectByID };